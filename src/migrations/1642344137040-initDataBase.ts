...
export class initDataBase1642344137040 implements MigrationInterface {
    name = 'initDataBase1642344137040'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "task" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying NOT NULL, "order" integer NOT NULL, "description" character varying NOT NULL, "userId" uuid, "boardId" character varying, "columnId" character varying, "board" uuid, CONSTRAINT "PK_fb213f79ee45060ba925ecd576e" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "task" ADD CONSTRAINT "FK_530d977c2d9eaa58ca931f3547a" FOREIGN KEY ("board") REFERENCES "board"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "task" DROP CONSTRAINT "FK_530d977c2d9eaa58ca931f3547a"`);
